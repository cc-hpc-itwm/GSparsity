...
def main():
    ...
    if args.dataset == 'cifar10':
        ...
        train_data = ImageNet16(root=os.path.join(args.data,''), train=True, transform=train_transform, use_num_of_class_only=120)
    ...
    ks = [4, 2]
    num_keeps = [5, 3]
    train_epochs = [2, 2] if 'debug' in args.save else [100]#, 50]
