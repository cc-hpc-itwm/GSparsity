...
class TinyNetwork(nn.Module):
  ...
  def new(self):
    model_new = TinyNetwork(self._C, self._layerN, self.max_nodes,self._classes, 
                            self._criterion,self._search_space,affine = self._affine,
                            track_running_stats=self._track_running_stats,k=self.k, 
                            species=self.species, reg_type= self._reg_type,reg_scale=self._reg_scale).cuda()
