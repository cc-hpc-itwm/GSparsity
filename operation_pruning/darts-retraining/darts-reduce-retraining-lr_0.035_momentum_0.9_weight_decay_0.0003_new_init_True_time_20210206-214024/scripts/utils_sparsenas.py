...
#         print(alpha_cell)
        ...
        for step_index in range(network_eval.steps):
            for edge_index in range(edge_offset[step_index], edge_offset[step_index] + step_index + 2):
                for kk in range(network_eval.num_ops):
                    if alpha_cell[edge_index][kk] == 1:
                        op_name = network_eval.ops[kk]
                        source_node = edge_index - edge_offset[step_index]
