...
parser.add_argument('--save', type=str, default='darts-original-retrain', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='RUN2_cutout', help='which architecture to use')
