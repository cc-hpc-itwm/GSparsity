...
if __name__ == '__main__':
    ...
    parser.add_argument('--last_epoch', type=int, default=569, help='the beginning epoch (new training if 0, or resume an existing training if >0)')
...
#     file_pretrained_model = "darts-pruning/darts-pruning-lr_0.001_edec_0_rho_0.9_rdec_0_mu_0.007_time_20210203-220138/full_weights"
    file_pretrained_model = "darts-pruning/darts-pruning-lr_0.001_edec_0_rho_0.9_rdec_0_mu_0.008_time_20210203-220212/full_weights"
#     file_pretrained_model = "darts-pruning/darts-pruning-lr_0.001_edec_0_rho_0.9_rdec_0_mu_0.009_time_20210203-220243/full_weights"
#     file_pretrained_model = "darts-pruning/darts-pruning-lr_0.001_edec_0_rho_0.9_rdec_0_mu_0.01_time_20210203-220309/full_weights"
    
    if args.last_epoch > 0:
        model_to_resume = "darts-freeze-retraining/darts-freeze-retraining-lr_0.035_momentum_0.9_weight_decay_0.0003_new_init_True_time_20210207-134911/full_weights"
        main(args, file_pretrained_model, model_to_resume) 
    else:
