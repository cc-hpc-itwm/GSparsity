...
#   python visualize.py alpha_network
  if len(sys.argv) != 2:
  ...
  try:
    alpha_network = eval('genotypes_sparse.{}'.format(alpha_name))
  except AttributeError:
    print("{} is not specified in genotypes_sparse.py".format(alpha_name)) 
    sys.exit(1)
