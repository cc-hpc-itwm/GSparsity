...
def main(args, path_to_model, model_to_resume=None):
    ...
    logger.info("The number of trainable parameters before and after operation pruning is {} MB and {} MB".format(utils.count_parameters_in_MB(model_to_prune), utils.count_parameters_in_MB(model)))
