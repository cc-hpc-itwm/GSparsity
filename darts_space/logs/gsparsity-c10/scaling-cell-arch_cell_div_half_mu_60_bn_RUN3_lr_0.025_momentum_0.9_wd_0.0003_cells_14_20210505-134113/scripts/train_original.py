...
parser.add_argument('--save', type=str, default='darts-original-retrain-predefined', help='experiment name')
parser.add_argument('--seed', type=int, default=None, help='random seed')
parser.add_argument('--arch', type=str, default='RUN1', help='which architecture to use')
...
fh = logging.FileHandler(os.path.join(args.save, '_log.txt'))
...
def main():
  ...
  for epoch in range(1, args.epochs+1):
    ...
    utils_sparsenas.acc_n_loss(train_obj_trajectory, valid_acc_trajectory, "{}/acc_n_loss.png".format(args.save), train_acc_trajectory, valid_obj_trajectory)
    ...
    if epoch % 10 == 0: #Plot Group sparsity every 10 epochs
      utils_sparsenas.plot_individual_op_norm(model, args.save+"/individual_operator_norm_epoch_{:03d}.png".format(epoch))
