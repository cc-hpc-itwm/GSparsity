...
parser.add_argument('--seed', type=int, default=12022, help='random seed')
parser.add_argument('--arch', type=str, default='ISTA_2stage_c100', help='which architecture to use')
