...
parser.add_argument('--momentum', type=float, default=0.6, help='momentum')
...
parser.add_argument('--use_sgd', action='store_true', default=False, help='new initialization after pruning')
...
def main(file_pretrained_model):
