...
def main(args, model_to_discretize, model_to_resume=None):
  ...
  network_search = network_params(args.init_channels_search, args.cells_search, 4, PRIMITIVES)
  network_eval = network_params(args.init_channels, args.cells, 4, PRIMITIVES)
  if args.scale_type == "cell":
      alphas, genotypes = utils_sparsenas.discretize_search_model_by_cell(model_to_discretize, network_eval, network_search, threshold=args.pruning_threshold) #alpha for each cell
  elif args.scale_type == "stage":
      alphas, genotypes = utils_sparsenas.discretize_search_model_by_stage(model_to_discretize, network_eval, network_search, threshold=args.pruning_threshold)
        
  assert len(alphas) == args.cells, "Each cell should have its individual alpha."
  logging.info("Model to discretize is in: {}\n".format(model_to_discretize))
#   logging.info("alphas:\n {}".format(alphas))
    
  model = Network(args.init_channels, CIFAR_CLASSES, args.cells, args.auxiliary, genotypes, alphas)
  model = model.cuda()    
...
if __name__ == '__main__':
    ...
    parser.add_argument('--remark', type=str, default="really with drop path", help='remark about the experiment')
...
#         model_to_discretize = "search-for-stage/search-for-stage-lr_0.001_rho_0.8_mu_10_div_0.5_pretrained_False_time_20201229-164756/full_weights"
    elif args.scale_type == "cell":
    #     model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_edec_0_rho_0.8_rdec_0_mu_0.3_time_20201211-071124/full_weights" #batch_size 48
    #     model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_edec_0_rho_0.8_rdec_0_mu_1_time_20201217-093441/full_weights" #batch_size 64
    #     model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_rho_0.8_mu_200_div_0.5_pretrained_False_time_20201229-164331/full_weights" #batch_size 64
#         model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_rho_0.8_mu_300_div_0.5_pretrained_False_time_20201229-164355/full_weights" #batch_size 64
        model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_rho_0.8_mu_12000_div_1_GC_0_time_20210117-212828/full_weights" #batch_size 48
#         model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_rho_0.8_mu_100_div_0.5_pretrained_False_time_20201228-203200/full_weights" #batch_size 48
    #     model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_rho_0.8_mu_50_div_0.5_pretrained_False_time_20210101-092524/full_weights" #batch_size 64

    if args.last_epoch > 0:
        model_to_resume = "scaling/scaling-lr_0.025_momentum_0.9_weight_decay_0.001_cells_30_time_20210106-213433/full_weights"
