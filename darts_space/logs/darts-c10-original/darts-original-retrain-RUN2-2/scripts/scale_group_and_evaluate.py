...
if __name__ == '__main__':
    ...
    parser.add_argument('--cells', type=int, default=17, help='total number of cells')
    ...
    parser.add_argument('--drop_path_prob', type=float, default=0.15, help='drop path probability')
...
#         model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_rho_0.8_mu_50_div_0.5_pretrained_False_time_20210101-092524/full_weights"
...
#         model_to_discretize = "search-for-cell/search-for-cell-lr_0.001_rho_0.8_mu_12000_div_1_GC_0_time_20210211-120516/full_weights"
    ...
    if args.last_epoch > 0:
        model_to_resume = "scaling-cell/scaling-cell-lr_0.025_momentum_0.9_weight_decay_0.0003_cells_14_time_20210213-192949/full_weights"
