...
parser.add_argument('--save', type=str, default='darts-original-retrain-full', help='experiment name')
...
def main():
  ...
  for epoch in range(1, args.epochs+1):
    ...
    utils_sparsenas.acc_n_loss(train_obj_trajectory, valid_acc_trajectory, "{}/acc_n_loss.png".format(args.save), train_acc_trajectory)
