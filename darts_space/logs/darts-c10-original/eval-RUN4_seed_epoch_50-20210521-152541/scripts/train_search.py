...
parser.add_argument('--last_epoch', type=int, default=-1, help='The last epoch of the previous training')
...
def main():
  ...
  if args.model_to_resume is not None:
        model.load_state_dict(torch.load("{}/full_model".format(args.model_to_resume)))
