...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_decay', type=float, default=70, help='weight decay (mu)')
    ...
    parser.add_argument('--save', type=str, default="search-for-cell-clip-nodec", help='experiment name (default None)')
