...
from ProxSGD_for_groups_adam_new import ProxSGD
...
def main(args):
    ...
    for epoch in range(last_epoch+1, args.epochs + 1):
        ...
        if epoch == 50:
            torch.save(model.state_dict(), "{}/model_final_halfway".format(args.save))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_decay', type=float, default=40, help='weight decay (mu)')
    ...
    parser.add_argument('--save', type=str, default="new-search-for-cell-clip", help='experiment name (default None)')
