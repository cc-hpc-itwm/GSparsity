...
def discretize_search_model_by_cell(model_path, network_eval, network_search, threshold, CIFAR_CLASSES = 100, normalization="none", normalization_exponent=0):
  """
...
def discretize_search_model_by_stage(model_path, network_eval, network_search, threshold=1e-5, CIFAR_CLASSES = 100, swap_stage=False):
  """
