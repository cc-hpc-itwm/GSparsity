...
parser.add_argument('--workers', type=int, default=10, help='number of workers to load dataset')
...
parser.add_argument('--save', type=str, default='imagenet-search/', help='experiment name')
...
parser.add_argument('--tmp_data_dir', type=str, default='/home/SSD/', help='temp data dir')
...
args.data_dir = os.path.join(args.tmp_data_dir, 'imagenet_search')
...
def main():
    ...
    #sys.exit(1)
   # dataset prepare
    traindir = data_dir = os.path.join(args.data_dir, 'train')
    valdir = data_dir = os.path.join(args.data_dir,  'val')
